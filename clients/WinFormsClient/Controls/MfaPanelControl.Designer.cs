...
partial class MfaPanelControl
{
  ...
  private void InitializeComponent()
  {
    ...
    _label.Location = new Point(0, 6);
    _label.Name = "_label";
    _label.Size = new Size(90, 15);
    _label.TabIndex = 0;
    _label.Text = "Challenge MFA:";
    // 
    // _challengeBox
    // 
    _challengeBox.Location = new Point(120, 2);
    _challengeBox.Name = "_challengeBox";
    _challengeBox.ReadOnly = true;
    _challengeBox.Size = new Size(240, 23);
    _challengeBox.TabIndex = 1;
    // 
    // _totpBox
    // 
    _totpBox.Location = new Point(120, 32);
    _totpBox.Name = "_totpBox";
    _totpBox.PlaceholderText = "TOTP (se richiesto)";
    _totpBox.Size = new Size(240, 23);
    _totpBox.TabIndex = 2;
    // 
    // _confirmMfaButton
    // 
    ...
    _qrBox.Location = new Point(200, 60);
    _qrBox.Name = "_qrBox";
    _qrBox.Size = new Size(160, 160);
    ...
    _mfaStatus.Location = new Point(0, 215);
    _mfaStatus.Name = "_mfaStatus";
    _mfaStatus.Size = new Size(42, 15);
